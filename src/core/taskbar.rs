...
pub use windows::Win32::UI::Shell::{
    TBPFLAG, TBPF_ERROR, TBPF_INDETERMINATE, TBPF_NOPROGRESS, TBPF_NORMAL,
};
...
pub fn update_download_state(_state: TBPFLAG) {
    #[cfg(target_os = "windows")]
    {
        if crate::core::Hachimi::instance()
            .config
            .load()
            .windows
            .taskbar_show_progress_on_download
        {
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        if !block
            && crate::core::Hachimi::instance()
                ...
                .load()
                .windows
                .taskbar_show_progress_on_connecting
        {
            crate::windows::taskbar::set_progress_state(_state);
        }
    }
...
pub fn update_schedule_state(_state: TBPFLAG, _block_connecting: bool) {
    #[cfg(target_os = "windows")]
    {
        if crate::core::Hachimi::instance()
            ...
            .load()
            .windows
            .taskbar_show_progress_on_schedule_book
        {
            crate::windows::taskbar::set_progress_state(_state);
