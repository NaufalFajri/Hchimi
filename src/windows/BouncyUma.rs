...
static STATE: Lazy<Mutex<BouncyUmaState>> = Lazy::new(|| {
    Mutex::new(BouncyUmaState {
        elapsed: 0.0,
    ...
    match easing_type {
        ...
        8 => {
            ...
            if value < 0.5 {
                ...
                (((2.0 * value - 2.0).powi(2) * ((c2 + 1.0) * (2.0 * value - 2.0) + c2)) + 2.0)
                    * 0.5
            }
        }
        9 => {
            ...
            if value == 0.0 || value == 1.0 {
                ...
                -(2.0_f32.powf(20.0 * value - 10.0) * ((20.0 * value - 11.125) * c5).sin()) * 0.5
            } else {
                (2.0_f32.powf(-20.0 * value + 10.0) * ((20.0 * value - 11.125) * c5).sin()) * 0.5
                    + 1.0
            }
...
pub fn default_bpm() -> f32 {
    DEFAULT_BPM
}
pub fn default_amplitude() -> f32 {
    DEFAULT_AMPLITUDE
}
