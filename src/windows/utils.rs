...
pub fn get_module_file_name(hmodule: HMODULE) -> Utf16String {
    ...
    let module_filename_str =
        unsafe { Utf16Str::from_slice_unchecked(&slice[..length]) }.to_owned();
    module_filename_str
}
...
pub fn vk_to_display_label(vk: u16) -> String {
    ...
    let name_map: &[(u16, &str)] = &[
        ...
        (km::VK_LMENU.0, "key_names.alt"),
        (km::VK_RMENU.0, "key_names.alt"),
        (km::VK_CONTROL.0, "key_names.ctrl"),
        (km::VK_LCONTROL.0, "key_names.ctrl"),
        (km::VK_RCONTROL.0, "key_names.ctrl"),
        (km::VK_SHIFT.0, "key_names.shift"),
        (km::VK_LSHIFT.0, "key_names.shift"),
        (km::VK_RSHIFT.0, "key_names.shift"),
