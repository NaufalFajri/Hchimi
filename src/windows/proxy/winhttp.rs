...
proxy_proc!(
    ...
    WinHttpDetectAutoProxyConfigUrl_orig
);
...
proxy_proc!(
    ...
    WinHttpGetProxySettingsVersion_orig
);
...
proxy_proc!(
    ...
    WinHttpWebSocketCompleteUpgrade_orig
);
proxy_proc!(
    WinHttpWebSocketQueryCloseStatus,
    WinHttpWebSocketQueryCloseStatus_orig
);
...
pub fn init(system_dir: &Utf16Str) {
    unsafe {
        ...
        WinHttpAddRequestHeaders_orig =
            utils::get_proc_address(handle, c"WinHttpAddRequestHeaders");
        ...
        WinHttpCreateProxyResolver_orig =
            utils::get_proc_address(handle, c"WinHttpCreateProxyResolver");
        WinHttpCreateUrl_orig = utils::get_proc_address(handle, c"WinHttpCreateUrl");
        WinHttpDetectAutoProxyConfigUrl_orig =
            utils::get_proc_address(handle, c"WinHttpDetectAutoProxyConfigUrl");
        WinHttpFreeProxyResult_orig = utils::get_proc_address(handle, c"WinHttpFreeProxyResult");
        WinHttpFreeProxyResultEx_orig =
            utils::get_proc_address(handle, c"WinHttpFreeProxyResultEx");
        WinHttpFreeProxySettings_orig =
            utils::get_proc_address(handle, c"WinHttpFreeProxySettings");
        WinHttpGetDefaultProxyConfiguration_orig =
        ...
        WinHttpGetProxyForUrlEx2_orig =
            utils::get_proc_address(handle, c"WinHttpGetProxyForUrlEx2");
        ...
        WinHttpGetProxySettingsVersion_orig =
            utils::get_proc_address(handle, c"WinHttpGetProxySettingsVersion");
        ...
        WinHttpQueryDataAvailable_orig =
            utils::get_proc_address(handle, c"WinHttpQueryDataAvailable");
        ...
        WinHttpReadProxySettings_orig =
            utils::get_proc_address(handle, c"WinHttpReadProxySettings");
        ...
        WinHttpSetStatusCallback_orig =
            utils::get_proc_address(handle, c"WinHttpSetStatusCallback");
        WinHttpSetTimeouts_orig = utils::get_proc_address(handle, c"WinHttpSetTimeouts");
        WinHttpTimeFromSystemTime_orig =
            utils::get_proc_address(handle, c"WinHttpTimeFromSystemTime");
        ...
        WinHttpWebSocketCompleteUpgrade_orig =
            utils::get_proc_address(handle, c"WinHttpWebSocketCompleteUpgrade");
        WinHttpWebSocketQueryCloseStatus_orig =
            utils::get_proc_address(handle, c"WinHttpWebSocketQueryCloseStatus");
        ...
        WinHttpWebSocketShutdown_orig =
            utils::get_proc_address(handle, c"WinHttpWebSocketShutdown");
        WinHttpWriteData_orig = utils::get_proc_address(handle, c"WinHttpWriteData");
        WinHttpWriteProxySettings_orig =
            utils::get_proc_address(handle, c"WinHttpWriteProxySettings");
    }
}
