...
def_field_value_accessors!(
    get_isStoppedFirstBGM,
    set_isStoppedFirstBGM,
    IS_STOPPED_FIRST_BGM_FIELD,
    bool
);
def_field_value_accessors!(
    get_isRequestFirstBGM,
    set_isRequestFirstBGM,
    IS_REQUEST_FIRST_BGM_FIELD,
    bool
);
def_field_value_accessors!(
    get_firstBGMDelayTime,
    set_firstBGMDelayTime,
    FIRST_BGM_DELAY_TIME_FIELD,
    f32
);
def_field_value_accessors!(
    get_firstBgmStopTime,
    set_firstBgmStopTime,
    FIRST_BGM_STOP_TIME_FIELD,
    f32
);
def_field_value_accessors!(
    get_isPlayedSecondBGM,
    set_isPlayedSecondBGM,
    IS_PLAYED_SECOND_BGM_FIELD,
    bool
);
def_field_value_accessors!(
    get_secondBgmStartTime,
    set_secondBgmStartTime,
    SECOND_BGM_START_TIME_FIELD,
    f32
);
def_field_object_accessors!(
    get_firstBgmCueName,
    set_firstBgmCueName,
    FIRST_BGM_CUE_NAME_FIELD,
    Il2CppString
);
def_field_object_accessors!(
    get_secondBgmCueName,
    set_secondBgmCueName,
    SECOND_BGM_CUE_NAME_FIELD,
    Il2CppString
);
def_field_value_accessors!(
    get_firstTriggerBgmPlayStartTime,
    set_firstTriggerBgmPlayStartTime,
    FIRST_TRIGGER_BGM_PLAY_START_TIME_FIELD,
    f32
);
def_field_value_accessors!(
    get_isPlayedFirstTriggerBgm,
    set_isPlayedFirstTriggerBgm,
    IS_PLAYED_FIRST_TRIGGER_BGM_FIELD,
    bool
);
...
pub fn init(umamusume: *const Il2CppImage) {
    ...
    unsafe {
        ...
        SECOND_BGM_START_TIME_FIELD =
            get_field_from_name(RaceBGMController, c"_secondBgmStartTime");
        ...
        {
            FIRST_TRIGGER_BGM_PLAY_START_TIME_FIELD =
                get_field_from_name(RaceBGMController, c"_firstTriggerBgmPlayStartTime");
            IS_PLAYED_FIRST_TRIGGER_BGM_FIELD =
                get_field_from_name(RaceBGMController, c"_isPlayedFirstTriggerBgm");
        }
    }
}
