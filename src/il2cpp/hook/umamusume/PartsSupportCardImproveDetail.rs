...
type SetupFn = extern "C" fn(
    ...
    workSupportCard: *mut Il2CppObject,
    buttonAction: *mut Il2CppDelegate,
    hash: i32,
    enableObtain: bool,
);
extern "C" fn Setup(
...
pub fn init(umamusume: *const Il2CppImage) {
    ...
    unsafe {
        TITLENAME_TEXT_FIELD =
            get_field_from_name(PartsSupportCardImproveDetail, c"_titleNameText");
        UNIQUEBONUS_NAME_FIELD =
            get_field_from_name(PartsSupportCardImproveDetail, c"_textUniqueBonusName");
    }
}
