use crate::{
    ...
    il2cpp::{
        ...
        symbols::{get_field_from_name, get_method_addr, IEnumerator, MoveNextFn},
        types::*,
    },
};
...
type GetChangeViewOrientationFn =
    extern "C" fn(this: *mut Il2CppObject, retOrientation: *mut Il2CppObject) -> IEnumerator;
extern "C" fn GetChangeViewOrientation(
    this: *mut Il2CppObject,
    retOrientation: *mut Il2CppObject,
) -> IEnumerator {
    let enumerator =
        get_orig_fn!(GetChangeViewOrientation, GetChangeViewOrientationFn)(this, retOrientation);

    unsafe {
        SOCW_RET_ORIENTATION = retOrientation;
    }
...
extern "C" fn GetChangeViewOrientation_MoveNext(enumerator: *mut Il2CppObject) -> bool {
    ...
    if !moved {
        // hasn't moved = enumerator just finished
        unsafe {
            ...
            if !wrapper.is_null() && Hachimi::instance().config.load().trainer_live_landscape {
                ...
                if orientation == ScreenOrientation_Portrait {
                    ScreenOrientationClassWrapper::set_Orientation(
                        wrapper,
...
pub fn init(umamusume: *const Il2CppImage) {
    ...
    let get_change_view_orientation_addr =
        get_method_addr(LiveViewController, c"GetChangeViewOrientation", 1);
