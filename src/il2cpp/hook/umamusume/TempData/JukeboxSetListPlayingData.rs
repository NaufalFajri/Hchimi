...
pub fn init(TempData: *mut Il2CppClass) {
    ...
    unsafe {
        GETMUSICLISTCOUNT_ADDR =
            get_method_addr(JukeboxSetListPlayingData, c"GetMusicListCount", 0);
        GETMASTERSETLISTMUSICDATA_ADDR =
            get_method_addr(JukeboxSetListPlayingData, c"GetMasterSetListMusicData", 0);
