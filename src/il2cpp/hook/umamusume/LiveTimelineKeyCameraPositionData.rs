...
extern "C" fn GetValue(
    ...
    if free_camera::is_live_secondary_camera_update() || is_multi_camera_position_data(this) {
...
extern "C" fn GetValue2(
    ...
    if free_camera::is_live_secondary_camera_update() || is_multi_camera_position_data(this) {
        return get_orig_fn!(GetValue2, GetValue2Fn)(ret, this, timeline_control, set_type);
    }
