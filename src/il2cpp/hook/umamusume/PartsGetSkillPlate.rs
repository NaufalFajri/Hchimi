...
type SetUpCharacterLimitBreakSkillFn = extern "C" fn(
...
extern "C" fn SetUpCharacterLimitBreakSkill(
    ...
    get_orig_fn!(
        ...
        SetUpCharacterLimitBreakSkillFn
    )(this, cardRairtyData, nextCardRairtyData, atlas);
...
pub fn init(umamusume: *const Il2CppImage) {
    ...
    let SetUpCharacterLimitBreakSkill_addr =
        get_method_addr(PartsGetSkillPlate, c"SetUpCharacterLimitBreakSkill", 3);
    new_hook!(
        SetUpCharacterLimitBreakSkill_addr,
        SetUpCharacterLimitBreakSkill
    );

    unsafe {
        NAME_CONTENTS_SIZE_FITTER_FIELD =
            get_field_from_name(PartsGetSkillPlate, c"_nameContentsSizeFitter");
