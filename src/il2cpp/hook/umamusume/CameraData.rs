...
pub fn init(umamusume: *const Il2CppImage) {
    ...
    unsafe {
        CLASS = CameraData;
        SET_ISOVERRIDESHADOWRESOLUTION_ADDR =
            get_method_addr(CameraData, c"set_IsOverrideShadowResolution", 1);
        SET_OVERRIDESHADOWRESOLUTION_ADDR =
            get_method_addr(CameraData, c"set_OverrideShadowResolution", 1);
    }
}
